...
print(
    "Hello " + Username + ", I'm so glad that you're here! There is a dragon wrecking havoc on the city... Can you please us kill it?")
KillorNot = input("Do you want to help your city's citizens kill the dragon? Y/N")

if KillorNot == "Y":
    print(
        "Oh thank you so much! The dragon is hiding in a secret lair under the town hall. You'll need some equipment first before you can take it on")
else:
    while KillorNot != "Y":
...
print(
    "Oh thank you so much! The dragon is hiding in a secret lair under the town hall. You'll need some equipment first before you can take it on")
# for loop, try to use dictionary, try to use array (if applicable)